...
import { Card, Typography, Button, CardContent, FormHelperText } from '@material-ui/core/';
...
export default class EmailVerification extends Component {
    ...
    handleClick() {
        ...
        axios.post('https://localhost/Codeigniter/verifyemail', { token: this.state.token })
            .then((response) => {
                this.setState(
                    {
                        status: true,
