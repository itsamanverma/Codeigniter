            ...
            <div style={{
                ...
                <Card className='logincard'>
                    <div className='label-forgetpass' >
                        <div className='logo'>
                            <img src={require('../assest/images/logo.svg')} alt="logo.svg" />
                    ...
                    <CardContent>
                        {this.state.status ?
                            (<div>
                                ...
                                <Button fullWidth color="primary" type='submit' onClick={this.handleLoginClick.bind(this)} >Login</Button>
                            </div>)
                            : (<div>
                                <Typography variant="h5" component="h2" id='login-text'>Forgot Password</Typography>
                                <div>
                                    <Input name='email' type={'Email'} placeholder={'Enter Your Email'} label={'Email'} onChange={this.getDataFromInput} />
                                </div><br/>
                                <div className='login-btn-div'>
                                    <Button variant="contained" color="primary" type='submit' onClick={this.handleLoginClick()} className='login-btn'>Submit</Button>
                                </div><br/>
                                <span className='right-text'><a href="/register">Sign Up</a></span>
                                <span className='left-text' ><a href="/login">Login</a></span>
                            </div>)
                        }
                    </CardContent>
                </Card>
